    ...
    reversible do |dir|
      dir.up do
        EcosystemMatrixUpdate
          ...
          .select(:id, '"algorithm_ecosystem_matrix_updates"."algorithm_name"')
        ...
        ExerciseCalculation
          ...
          .select(:id, '"algorithm_exercise_calculations"."algorithm_name"')
        ...
        StudentClueCalculation
          ...
          .select(:id, '"algorithm_student_clue_calculations"."algorithm_name"')
        ...
        TeacherClueCalculation
          ...
          .select(:id, '"algorithm_teacher_clue_calculations"."algorithm_name"')
