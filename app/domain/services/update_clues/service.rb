class Services::UpdateClues::Service
  ...
  def process
    ...
    loop do
      ...
      new_responses = Response.joins(:course, :exercise)
      ...
      # Mark the new_responses as used in CLUe calculations
      ...
      # If we got less responses than the batch size, this means that this is the last batch
      num_responses = new_responses.size
